-- ==============================================================================
-- 钱包系统数据库表创建脚本
-- Wallet System Database Tables Creation Script
-- 
-- 使用说明:
-- 1. 在 SQL Server Management Studio (SSMS) 中打开此脚本
-- 2. 连接到您的数据库 (RecyclingSystemDB)
...
-- ==============================================================================
-- 4. 更新现有用户的 money 字段默认值（如果为 NULL）
-- ==============================================================================
UPDATE [dbo].[Users]
SET [money] = 0.00
WHERE [money] IS NULL;
...
PRINT '钱包系统表创建完成！';
PRINT '已创建以下表：';
PRINT '1. UserPaymentAccounts - 用户支付账户表';
PRINT '2. WalletTransactions - 钱包交易记录表';
PRINT '3. Users.money - 用户余额字段（如不存在则创建）';
GO
